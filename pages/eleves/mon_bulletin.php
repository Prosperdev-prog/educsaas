...
<div class="content-body">
    <div class="container-fluid mt-3 text-dark pb-5">
        <div class="d-flex justify-content-between align-items-center mb-4 pt-3">
             <div>
                <h1 class="h3 mb-0 fw-bold">Mon Bulletin Scolaire</h1>
                <p class="text-muted small">Suivi récapitulatif de vos performances ce trimestre.</p>
             </div>
                ...
                <div class="card border-0 shadow-sm" style="border-radius: 20px;" id="premium-notice">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <h5 class="fw-bold mb-0">Version PREMIUM</h5>
                        </div>
                        <p class="text-muted small">La génération de <b>bulletins PDF officiels</b> avec QR Code et signature numérique est réservée aux écoles partenaires PREMIUM.</p>
                        <a href="pricing.php" class="btn btn-warning btn-sm rounded-pill w-100 fw-bold">En savoir plus</a>
                    </div>
                </div>
            </div>
        </div>
